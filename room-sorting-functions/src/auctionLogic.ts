import { Auction, Room, User, Bid, Conflict } from "./types";
 ...
 */
export const sumRoomPrices = (rooms: Room[]): number => {
 ...
 */
export const detectConflicts = (auction: Auction, selections: Record<string, string | null>): Conflict => {
 ...
 */
export const applySelections = (auction: Auction, selections: Record<string, string | null>): Auction => {
